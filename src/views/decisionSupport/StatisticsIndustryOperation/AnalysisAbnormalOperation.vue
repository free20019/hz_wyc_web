  ...
  <div class="tw-template-wrapper">
    ...
    <div class="tw-query-panel" ref="queryPanel">
      ...
      >
        ...
        <el-table-column prop="CAR_NUM" align="center" label="动态车辆数" width="140"></el-table-column>
        ...
        <el-table-column prop="CAR_COMPLIANCE_ORDER" align="center" label="人违规订单数" width="140"></el-table-column>
        <el-table-column
      ...
      if (!this.query.time || this.query.time == '') {
        ...
        axios
          ...
          .then(res => {
            ...
            totalList.push(...tableData)
            _.each(totalList, item => {
              item.CAR_NUM = parseInt(item.CAR_NUM)
            })
            this.table.data = totalList
            setTimeout(() => {
              this.table.loading = false
            }, 600)
          })
