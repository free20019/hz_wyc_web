  ...
  <div class="tw-template-wrapper">
    ...
    <div class="tw-query-panel" ref="queryPanel">
      ...
      >
        ...
        <el-table-column prop="HYJSY" align="center" label="活跃驾驶员" width="200"></el-table-column>
        <el-table-column prop="HYCL" align="center" label="活跃车辆" width="200"></el-table-column>
        <el-table-column prop="ZDD" align="center" label="总订单" width="220"></el-table-column>
        <el-table-column prop="ZYS" align="center" label="总营收(元)" width="220"></el-table-column>
        <el-table-column prop="ZXSLC" align="center" label="总行驶里程(公里)" width="200"></el-table-column>
        <el-table-column
          prop="ZZKSC"
          align="center"
          label="总载客时长(分)"
...
export default {
  ...
  methods: {
    ...
    handleQueryDC() {
      let url = `${this.baseURL}map/qyrjyytjexcle?type=2&time=${this.timeFormatter(this.query.time)}`
      window.open(url)
    }
  }
}
