...
.tw-total-menu {
  ...
  &-close {
    ...
    right: 5px;
    padding: 7px;
    font-size: $tw-menu-total-fontSize;
    font-weight: bold;
    color: #595959;
    cursor: pointer;
    &:hover {
  ...
  &-query {
    ...
    &-box {
      ...
      &:focus {
        border-bottom: 1px solid $tw-menu-itemBColor;
        color: #333333;
      }
    }
    &-text {
      font-size: 16px;
      color: $tw-menu-itemBColor;
    }
    &-prompt {
      padding-top: 20px;
      font-size: $tw-menu-total-fontSize;
  ...
  &-group {
    ...
    &-item {
      ...
      &-header {
        ...
        font-size: $tw-menu-total-fontSize_default;
        font-weight: 600;
        color: $tw-menu-total-color_default;
      }
      &-body {
        margin: 0;
        padding: 0;
        ...
        &-item {
          ...
          .tw-menu-link {
            display: block;
            overflow: hidden;
            height: $tw-menu-itemHeight - 10px;
            padding: 0 10px;
            line-height: $tw-menu-itemHeight - 10px;
            font-size: $tw-menu-total-fontSize;
  ...
  &-system {
    ...
    &-item {
      ...
      &:hover {
        margin-left: -2px;
        border-left: 2px solid $tw-menu-itemBColor;
        font-weight: 700;
        color: $tw-menu-itemBColor;
      }
    }
