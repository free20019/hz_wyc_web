  ...
  <div class="tw-template-wrapper">
    ...
    <div class="tw-query-panel" ref="queryPanel">
      ...
      >
        ...
        <el-table-column prop="ZZKSC" align="center" label="总载客时长(分)" min-width="160" :resizable="false"></el-table-column>
      </el-table>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleQueryDC() {
      let url = `${this.baseURL}map/qyrjyytjexcle?time=${this.timeFormatter(this.query.time)}&type=4`
      window.open(url)
    }
  }
}
